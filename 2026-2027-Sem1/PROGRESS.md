...
**Legend** — **Deck**: slides collected (🔴 *mandatory — no deck, no note*) · Note: session note written · Card: closed-book card done (sessions 1–8 only) · Open: open-book page done · Lab: lab code runs
